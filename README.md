...
Compute MSS, ASS, OSI scores
Match the input to the dataset (using Euclidean distance for nearest similarity)
Predict the severity class
Display visual plots comparing actual vs predicted trends
Provide personalized lifestyle suggestions
Sample Output
